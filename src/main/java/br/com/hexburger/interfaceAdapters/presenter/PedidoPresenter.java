...
public class PedidoPresenter {
    ...
    public static PedidoDTO toDTO(Pedido pedido) {
        return new PedidoDTO(pedido.getId(), pedido.getCodigo(), getCombosDTO(pedido), pedido.getValorTotal(), getClienteDTO(pedido), pedido.getStatus(), pedido.getStatusPagamento(), pedido.getDataPedido());
    }
